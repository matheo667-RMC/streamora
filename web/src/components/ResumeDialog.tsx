...
export function ResumeDialog({ seriesId, onResume }: Props) {
  ...
  return (
    <div className="rounded-xl border border-red-500/30 bg-red-600/10 p-4 mb-6 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm text-white">
            ...
            {lastWatched.season && <span className="text-red-400"> (S{lastWatched.season} E{lastWatched.episodeNumber})</span>}
          </p>

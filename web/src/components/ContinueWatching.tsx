  ...
  return (
    <section className="rounded-xl border border-white/5 bg-[#141414]/80 p-4 sm:p-6">
      <div className="flex items-center gap-3 mb-5">
        <div className="flex items-center gap-1.5 rounded-md bg-red-600 px-4 py-2 text-sm font-bold text-white">
            ...
            >
              <div className="relative aspect-[2/3] rounded-lg overflow-hidden bg-gray-900 ring-1 ring-white/10 transition-all duration-300 group-hover:ring-red-500/50 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-red-900/30">
                {item.posterUrl ? (
                  ...
                  <div className="flex h-full items-center justify-center bg-gradient-to-br from-red-900/30 to-red-900/20 text-gray-600">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-2">
                  ...
                  {item.type === "episode" && item.season && (
                    <p className="text-[10px] text-red-400 font-medium">S{item.season} E{item.episodeNumber}</p>
                  )}
                </div>
              </div>

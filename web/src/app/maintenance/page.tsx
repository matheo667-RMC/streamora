  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4 text-center">
      <div className="max-w-lg">
        ...
        <div className="w-16 h-1 bg-gradient-to-r from-red-500 to-red-400 rounded-full mx-auto mb-6" />
        <p className="text-lg text-gray-300 mb-2">{msg}</p>
        <p className="text-sm text-gray-500">Nous revenons très bientôt !</p>
        <div className="mt-10 flex justify-center gap-3">
          <div className="h-3 w-3 rounded-full bg-red-500 animate-bounce" style={{ animationDelay: "0s" }} />
          <div className="h-3 w-3 rounded-full bg-red-500 animate-bounce" style={{ animationDelay: "0.15s" }} />
          <div className="h-3 w-3 rounded-full bg-red-500 animate-bounce" style={{ animationDelay: "0.3s" }} />
        </div>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-950 px-4 text-center relative overflow-hidden">
      ...
      <div className="max-w-lg z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-red-400 to-red-400 drop-shadow-[0_0_30px_rgba(168,85,247,0.3)]">
          MAINTENANCE
        </h1>

        <div className="my-6 h-px bg-gradient-to-r from-transparent via-red-500 to-transparent" />

        <p className="text-lg text-gray-200 mb-2 font-light">{msg}</p>

        <div className="mt-10 inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-red-500/50 bg-red-500/5 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
          <div className="w-2 h-2 rounded-full bg-red-400 animate-ping" />
          <span className="text-sm text-red-300">Mise à jour en cours</span>
        </div>
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-black via-gray-950 to-black px-4 text-center relative overflow-hidden">
      ...
      <div className="max-w-lg z-10">
        ...
        <div className="w-full max-w-xs mx-auto h-1.5 bg-gray-800 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-red-500 to-red-400 rounded-full animate-[progress_3s_ease-in-out_infinite]" style={{

    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="relative pt-20 pb-6 px-4 sm:px-6">
        ...
        <div className="relative mx-auto max-w-[1400px]">
          <div className="flex items-center gap-3 mb-4">
            <h1 className="flex items-center gap-2 rounded-md bg-red-600 px-4 py-2 text-lg font-bold">
              Films
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pb-16">
        {films.length > 0 ? (
              ...
              <Link key={film.id} href={`/films/${film.id}`} className="group">
                <div className="relative aspect-[2/3] rounded-lg overflow-hidden bg-gray-900 ring-1 ring-white/10 transition-all duration-300 group-hover:ring-red-500/50 group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-red-900/30">
                  ...
                  <div className="absolute top-1.5 right-1.5">
                    <span className="rounded bg-red-600/90 px-1.5 py-0.5 text-[9px] font-bold leading-none">{film.category}</span>
                  </div>
                </div>
          ...
          <div className="rounded-xl border border-white/5 bg-[#141414]/80 p-12 text-center">

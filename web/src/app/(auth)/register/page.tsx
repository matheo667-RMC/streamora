      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-black/60 backdrop-blur-2xl p-8 md:p-10 shadow-2xl">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#5865F2] px-6 py-3.5 font-semibold text-white hover:bg-[#4752C4] transition-all"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#1877F2] px-6 py-3.5 font-semibold text-white hover:bg-[#166FE5] transition-all"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">

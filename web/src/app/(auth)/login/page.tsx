        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            {step === "2fa"
              ...
              : "Connecte-toi pour accéder à tes films et séries"}
          </p>
        </div>
          ...
          <form onSubmit={handle2FA} className="space-y-4">
            ...
            <div className="rounded-lg border border-red-500/20 bg-red-500/5 p-4 text-center">
              <div className="text-4xl mb-2">
                <svg className="h-12 w-12 mx-auto text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <input
              ...
              maxLength={6}
              autoFocus
              className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-4 text-white text-center text-2xl tracking-[0.5em] font-mono placeholder-gray-600 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500 transition-colors"
            />

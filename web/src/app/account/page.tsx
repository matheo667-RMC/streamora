        ...
        <div className="relative pt-20 pb-8 px-4">
          ...
          <div className="relative mx-auto max-w-xl">
            <h1 className="text-2xl sm:text-3xl font-bold">
              <span className="bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">Mon compte</span>
            </h1>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-xl px-4 pb-10">
          ...
          <div className="rounded-2xl border border-white/10 bg-gray-900/50 p-6 mb-6">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 rounded-full bg-gradient-to-br from-emerald-600 to-green-600 flex items-center justify-center text-2xl font-bold flex-shrink-0 ring-2 ring-emerald-500/20">
              ...
              <form onSubmit={handleChangePassword} className="space-y-4">
                <div>
                  ...
                  <input type="password" value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} required
                    className="mt-1 w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-white placeholder-gray-500 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-colors"
              ...
              {twoFAStep === "verify" && (
                <div>
                  ...
                  <div className="mb-4 rounded-lg bg-gray-800/50 p-3">
                    ...
                    <p className="text-xs font-mono text-emerald-400 break-all select-all">{secretKey}</p>
                  </div>
                  ...
                  <form onSubmit={verify2FA} className="space-y-3">
                    <div>
                      ...
                      <input type="text" value={totpCode}
                        ...
                        className="mt-1 w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-white text-center text-xl tracking-[0.5em] font-mono placeholder-gray-600 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-colors"
                        placeholder="000000" />
                    </div>
              ...
              {twoFAStep === "disable" && (
                <form onSubmit={disable2FA} className="space-y-3">
                  ...
                  <input type="password" value={disablePassword}
                    ...
                    required autoFocus
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-white placeholder-gray-500 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-colors"
